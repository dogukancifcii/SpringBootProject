package com.dogukan.payload.request.abstracts;
...
//bu kismi update ederken kullanicaz
@SuperBuilder
@Data
@AllArgsConstructor
@NoArgsConstructor
public abstract class AbstractUserRequest {
    ...
    @Past(message = "Your birthday can not be in the future") //girdigi tarih daha eski olmali
